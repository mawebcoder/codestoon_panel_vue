<template>
  <div>
    ...
    <DataTable :force-delete="true" restore-url="courses/restore" force-delete-url="courses/force/delete"
               :showRestore="true" :isTrash="true"
               server-search-route="courses/search-items?trash=true" :items="rows"
