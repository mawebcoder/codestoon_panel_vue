<template>
  <div>
    ...
    <md-dialog style="padding: 20px" :md-fullscreen="true" :md-active.sync="showDialog">
      ...
      <md-dialog-actions>
        <md-button style="margin: 0 10px" @click="submitDialog" class="md-raised md-accent">تایید</md-button>
        <md-button @click="showDialog = false" class="md-raised md-primary">انصراف</md-button>
      </md-dialog-actions>
    ...
    <md-field>
      ...
      <md-input type="password" placeholder="رمز فعلی..." v-model="currentPassword"></md-input>
    </md-field>
    ...
    <md-field>
      <md-input type="password" placeholder=" رمز عبور جدید..." v-model="password"></md-input>
    </md-field>
...
export default {
  ...
  created() {
    ...
    // console.log(this.$store.state.profileImage)
  },
  data() {
    return {
      name: '',
  ...
  methods: {
    ...
    submit() {
      ...
      if (!this.$cookies.get('temporaryPassword')) {
        ...
        data.append('temporaryPassword', this.$cookies.get('temporaryPassword'));
